...
origfilepath = 'D:Juggling/' +subject + '/' + sessionID
configPath = 'D:Juggling/DLCNetworks/Juggle-CC-2020-03-24/config.yaml'

datadir1 = [origfilepath+'/RawGoProData']
...
for dir in datadir1:
    for video in os.listdir(dir):
        ...
        subprocess.call(['ffmpeg', '-i', origfilepath+'/RawGoProData/'+video, '-vf', 'scale=1280:960', filepath1+'/'+video])
